  ...
  return (
    <div className="min-h-screen bg-[#060a17] flex flex-col page-shell">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="surface-card rounded-3xl p-5 md:p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h2 className="page-title text-[2rem] md:text-[2.35rem]">Hall of Fame</h2>
            <p className="page-subtitle mt-2">Archive of past KIET hackathon finalist decks, slide templates, and tips.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 pb-4 border-b border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        {(currentUser && (ppt.author_id === currentUser.id || isAdminUser(currentUser))) && (
                          <button
                            ...
                            className="secondary-btn h-8 px-3 text-xs !text-red-200 !border-red-500/20 !bg-red-500/5 hover:!bg-red-500/10"
                          >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-4">
              {loading ? (
                ...
                <div className="empty-state p-6 rounded-2xl text-center text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        {(currentUser && (tip.author_id === currentUser.id || isAdminUser(currentUser))) && (
                          <button
                            ...
                            className="secondary-btn h-8 px-2.5 text-[10px] !text-red-200 !border-red-500/20 !bg-red-500/5 hover:!bg-red-500/10"
                          >
                        ...
                        <button
                          ...
                          className="quiet-btn h-8 px-2.5 text-[10px]"
                        >
